 ...
 */
export const DEMO_CROSSFADE_SEC = 1.6;
...
/** テロップ表示（読了） */
export const DEFAULT_TELOP_MS = 4800;
/** ログ・章ビュー表示後のホールド（次シーンへ進む前） */
export const DEFAULT_HOLD_AFTER_REVEAL_MS = 9000;
/** テロップ消去〜ログ反映の間（クロスフェードと同周期） */
export const CROSSFADE_GAP_MS = DEMO_CROSSFADE_MS;
/** 最終シーン表示ホールド後、ホームに戻るまで */
export const LOOP_RESET_HOME_MS = 6000;
