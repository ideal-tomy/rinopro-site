...
業種、いまいちばんやりたいこと・課題、会社やチームの人数のイメージ、いつ頃までにという希望、今お使いのツールや他のシステムとのつなぎ、主な使い方・載せる場所、扱う情報に個人情報は含まれますか、誰が使う・見るか（社内・外部）、いまの情報の扱い方（中心）、情報の更新の頻度、見た目・デザインの期待、ログインの使い方、（任意）うまくいっていないこと、気になること・制約、など。
