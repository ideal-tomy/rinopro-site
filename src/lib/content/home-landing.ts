...
export const homeLandingCopy = {
  ...
  ceo: {
    ...
    message:
      "大手企業の変革支援の現場で、優れた戦略が実装に届かず止まる場面を何度も見てきました。AXEONは、その「分断」を埋めるために立ち上げました。AIで人を置き換えるのではなく、人が本当に向き合うべき仕事に集中できる社会をつくること。それが、私たちの考える日本の次の生産性であり、国力を上げる実務だと信じています。",
    profileHref: "/about",
