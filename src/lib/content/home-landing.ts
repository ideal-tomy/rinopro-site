...
export const homeLandingCopy = {
  firstView: {
    headlineLine1: "軸を持って、前へ。",
    headlineLine2: "恩送りで、国の力を、もう一段。",
    subheadline:
      "AIという最先端技術で、人が「人にしかできないこと」に集中できる社会へ。",
    body:
  ...
  empathy: {
    sectionIndex: "02",
    sectionKicker: "ABOUT NAME",
    heading: "AXEON という名前に込めた、二つの意味。",
    cards: [
      {
        icon: "🧭",
        prefix: "Axis × On (アクシス・オン)",
        emphasis:
      ...
      },
      {
        ...
        prefix: "軸 × 恩 (じく・おん)",
        emphasis:
          "日本語で読めば、「軸」と「恩」。受け取った恩を、次の世代と社会へ返していく。",
      },
    ],
    bridge: "私たちは、企業の軸を共につくるパートナーであり、恩送りのために仕事をします。",
  },

  mission: {
    sectionIndex: "03",
    sectionKicker: "MISSION",
    heading: "国の力を、もう一段。",
    intro:
      "私たちが目指すのは、AIで人を置き換えることではありません。人が「人にしかできないこと」に集中できる仕組みをつくることです。",
    paragraphs: [
      "定型業務、転記作業、検索、要約、整理。人がやらなくていい仕事をAIに任せる。",
      "創造、判断、関係構築、本質的な議論。人にしかできない仕事に時間を返す。",
      "それが、AXEONの考えるAI活用の本質です。",
    ],
  },
  ...
  solutions: {
    ...
    items: [
      { title: "DX戦略設計", body: "課題を構造化し、実装可能な戦略に落とし込みます。", href: "/services/consulting" },
      { title: "AI業務アプリ開発", body: "現場運用を前提にした高速実装で、PoC止まりを防ぎます。", href: "/services/development" },
      { title: "データ活用基盤構築", body: "分散データを整理し、意思決定に使える形に統合します。", href: "/services" },
      { title: "内製化支援", body: "ツール導入だけで終わらず、チームに知見を移管します。", href: "/services" },
      { title: "業界別ソリューション", body: "業種固有の制約を踏まえた導入設計を行います。", href: "/solutions/manufacturing" },
      { title: "伴走型改善運用", body: "導入後の改善サイクルまで伴走し、成果を積み上げます。", href: "/contact" },
    ],
  },
  ...
  company: {
    ...
    heading: "Company",
    lead:
      "AXEON は、戦略コンサルティングの視点とAI実装力を統合した少数精鋭チームです。",
    body:
