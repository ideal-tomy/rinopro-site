...
export const homeConsultingSectionCopy = {
  ...
  body: "診断して終わり、レポートを出して終わり。\nそんなコンサルティングは卒業しましょう。\n私たちは現場の最前線に飛び込み、ITが「当たり前の道具」として定着するまで並走し続けます。\n過剰な提案でコストを膨らませるのではなく、今の組織にとって最も効果的な「次の一手」を共に実行し、自走できる組織へと導きます。",
...
export const demoHubCopy = {
  ...
  guide:
    "体験demoによって、漠然とした課題への気づきが得られます。また、解決策へのヒントにも役立ちます。",
  /** 体験ハブ：条件ウィザードを開く（カード内はボタンのみ） */
  conciergeCtaLabel: "条件から検索する",
