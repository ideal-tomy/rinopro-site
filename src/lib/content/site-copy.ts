    ...
    profiles: [
      {
        ...
        name: "秋吉 莉乃",
        body: [
          "幼少期から日本の長い歴史や、先人たちが繋いできたこの国が持つ独自の文化や底力に、漠然としながらも強い愛着を持って育ちました。その想いが確信に変わったのは、米国UCLAへの留学時代です。外の世界に出たことで、海外から日本がいかに高く評価され、信頼されているかを身をもって実感しました。",
          "しかし帰国後、目にしたのはDXの遅れや、社会の構造的な噛み合わせの悪さから本来の力を発揮しきれていない日本の姿でした。「このままではいけない」という歯痒さを抱え、ブロックチェーンをはじめとする先端技術の社会実装を目指して外資系コンサルティングファームへ入社しました。",
          "前職では、大企業や政府機関の変革支援という、非常にやりがいのある実務を経験させていただきました。しかし、日本の企業の約99.7%を占め、かつ重要な技術やサプライチェーンの核を担っているのは「中小企業」です。この中小企業が強くならなければ、日本の国力が底上げされることはない。そう痛感する一方で、大手コンサルティングファームの仕組みやコスト構造上、本当に支援が必要な中小企業へ直接手を差し伸べることが極めて難しいという、大きなジレンマにも直面しました。",
          "「優れた戦略や先端技術を、日本の底力を支える現場に直接届け、実装する存在が必要だ」",
          "その強い危機感と決意から、私はAXEON（アクシオン）を立ち上げました。AIや先端技術は、人を置き換えるためのものではありません。日本の素晴らしい現場が、本来の強みやクリエイティビティに集中できる環境をつくること。それこそが、日本の次の生産性を生み出し、真の意味で「国力を上げる」実務だと信じています。",
        ],
      },
    ],
  },
