    ...
    profiles: [
      {
        ...
        name: "秋吉 莉乃",
        body:
          "UCLA卒業後、外資系コンサルティングファームにて大手企業の変革に関わる中で、製造・金融・流通・医療など幅広い業界の変革プロジェクト経験を重ねてきました。大手企業の変革支援の現場で、優れた戦略が実装に届かず止まる場面を何度も見てきました。AXEONは、その「分断」を埋めるために立ち上げました。AIで人を置き換えるのではなく、人が本当に向き合うべき仕事に集中できる社会をつくること。それが、私たちの考える日本の次の生産性であり、国力を上げる実務だと信じています。",
      },
    ],
  },
  principles: {
