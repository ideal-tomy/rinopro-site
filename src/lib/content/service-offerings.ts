...
const OFFERINGS: readonly ServiceOfferingDetail[] = [
  {
    ...
    why: {
      ...
      paragraphs: [
        "生成AIやクラウドの選択肢が増えた結果、「ツール選定」だけが先行し、組織・データ・権限の前提が後追いになるケースが増えています。経営が期待するスピードと、現場が守るべき品質・コンプライアンスは両立可能ですが、そのために最初に整えるべき論点が異なります。",
        "戦略設計の役割は、スローガンを置くことではなく、投資判断に耐える「優先順位」と「検証単位」を一枚にまとめることです。そこが揃うと、PoCと本実装の境界、関係部署の役割分担、外部パートナーへの依頼範囲まで会話が速くなります。",
      ],
      callouts: [
        {
          label: "経営視点",
    ...
    issues: {
      ...
      cards: [
        ...
        {
          title: "組織とガバナンス",
          body: "意思決定のゲート（誰が何を承認するか）、変更管理の頻度、教育計画まで含めて設計します。",
        },
        {
          title: "既存システムとの関係",
  ...
  },
  {
    ...
    metaDescription:
      "現場運用を前提にしたAI業務アプリ開発。PoC止まりを防ぐ進め方、検討すべき技術・運用論点、自社開発との役割分担までを整理します。",
    hero: {
      eyebrow: "SERVICE",
      title: "AI業務アプリ開発",
      lead:
    ...
    why: {
      ...
      paragraphs: [
        ...
        "AI駆動開発はスピードの武器ですが、そのスピードを「検証に使う」か「本番に直結させる」かでコントロールポイントが変わります。私たちは後者に耐える設計を初期から織り込みます。",
      ],
      callouts: [
        {
          label: "品質",
          text: "評価指標・テストデータ・ヒューマンレビュー境界を先に定義し、精度のブレを運用で吸収できる構造にします。",
        },
        {
          label: "スピード",
    ...
    issues: {
      ...
      cards: [
        ...
        {
          title: "監査・説明責任",
          body: "ログと参照根拠の出し方、誤り時のエスカレーション、再実行ポリシーを決めます。",
        },
        {
          title: "既存連携",
          body: "API・ファイル・メッセージングのどれで繋ぐか、リトライと冪等性の要件を整理します。",
        },
        {
          title: "運用オーナー",
          body: "誰がプロンプトやルールを更新し、誰が承認するか。リリース後の責任分界を決めます。",
        },
      ],
    },
    journey: {
  ...
  },
  {
    ...
    hero: {
      ...
      title: "データ活用基盤構築",
      lead:
        "データレイク／ウェアハウス／マートの役割分担から、品質・権限・スケジューリングまでを一体で設計し、ダッシュボードとAIの両方に燃料を供給する基盤を構築します。",
    ...
    why: {
      ...
      paragraphs: [
        ...
        "基盤の目的は「すべてを一カ所に」ではなく、**出所・更新責任・利用許諾が追える状態**をつくることです。その上で、必要な粒度だけをマートに載せ、現場と経営の両方に届けます。",
      ],
      callouts: [
        {
          label: "ガバナンス",
          text: "個人情報・機密区分ごとにマスキングと権限モデルを設計し、越境利用を防ぎます。",
        },
        {
          label: "運用",
          text: "パイプラインの監視とデータ契約（SLA）を決め、沈黙する欠損に気づけるようにします。",
        },
      ],
    },
    issues: {
      ...
      cards: [
        ...
        {
          title: "パイプライン設計",
          body: "バッチとストリーミングの境界、リトライ、冪等性、コスト上限を設計します。",
        },
        {
          title: "セキュリティ",
    ...
    pitfalls: {
      ...
      stumblingItems: [
        ...
        "現場のExcel／個別DBが残り、公式の数値が固定されない",
        "パイプライン障害に気づく監視がなく、気付いたら数ヶ月壊れていた",
      ],
      supportTitle: "AXEONの支援の重点",
      supportItems: [
        "ビジネスドメイン単位でスコープを切り、早期に価値が出る経路を優先",
    ...
    outcomes: {
      ...
      bullets: [
        ...
        "AIや自動化に渡せるデータパイプラインが稼働する",
        "障害とドリフトに早期に気づき、継続的に直せる",
      ],
      futureParagraph:
  ...
  },
  {
    ...
    hero: {
      ...
      title: "内製化支援",
      lead:
        "ハンドオフの粒度はお客様の体制に合わせます。設計レビュー、ペア実装、運用インシデント対応の伴走など、自走できる状態まで段階的に移します。",
      contactQuery: "topic=insourcing",
    },
    why: {
      heading: "なぜ内製化がDXの分水嶺になるか",
      paragraphs: [
      ...
      callouts: [
        ...
        {
          label: "ガードレール",
          text: "レビュー観点とゲートを先に決め、内製初期の品質とセキュリティを守ります。",
        },
      ],
    },
    issues: {
      ...
      cards: [
        {
          title: "内製のスコープ",
          body: "どこまでを内製し、どこを外部に残すか。コアドメインと非機能要件の分担を決めます。",
        },
        {
          title: "人員計画",
          body: "プロダクトオーナー、開発、SRE、データ責任者の役割と人数感を現実的に見積もります。",
        },
        {
          title: "研修と評価",
        ...
        {
          title: "ツールチェーン",
          body: "CI/CD、監視、IaCをどこまで内製で触るか、許可されたクラウド操作範囲を決めます。",
        },
        {
          title: "ベンダー関係",
          body: "SLA、ソースコードの所在、ライセンス、引き継ぎ条件を契約に反映します。",
        },
      ],
    },
    journey: {
    ...
    pitfalls: {
      ...
      supportTitle: "AXEONの支援の重点",
      supportItems: [
        "テンプレート化された設計書・運用Runbookを共著で作成",
        "ペアレビューとゲート設計で初期の品質を担保",
        "障害訓練とポストモーテムの型を導入",
      ],
    },
    outcomes: {
  ...
  },
  {
    ...
    why: {
      ...
      paragraphs: [
        "同じ「チャットボット」でも、医療・建設・士業では守るべき境界とログ要件がまったく異なります。業界に無関係なベストプラクティスをそのまま移植すると、現場で承認が通らないか、コンプライアンスリスクが残ります。",
    ...
    issues: {
      ...
      cards: [
        ...
        {
          title: "ステークホルダー",
          body: "協力会社・店舗・本社・監査の利害を整理し、承認ゲートを設計します。",
        },
        {
          title: "データの機密度",
  ...
  },
  {
    ...
    hero: {
      ...
      title: "伴走型改善運用",
      lead:
        "ローンチはゴールではなく起点です。利用実態・エラー・コスト・ユーザー声を定例で咀嚼し、優先度付きの改善バックログへ落とし込みます。",
    ...
    issues: {
      ...
      cards: [
        {
          title: "SLAとオンコール",
          body: "障害の深刻度別の対応時間、連絡経路、エスカレーションを定義します。",
        },
        {
          title: "変更管理",
          body: "リリース頻度、ロールバック、フィーチャーフラグの運用を決めます。",
        },
        {
          title: "コスト監視",
        ...
        {
          title: "ユーザー支援",
          body: "問い合わせ一次対応、ナレッジ更新、教育コンテンツのOwnerを決めます。",
        },
        {
          title: "セキュリティパッチ",
    ...
    pitfalls: {
      ...
      supportItems: [
        ...
        "バックログの優先順位付け（効果×緊急度）をファシリテート",
        "重大インシデントではサーバサイドも含めてトリアージ支援",
      ],
    },
    outcomes: {
      heading: "得られる状態・将来像",
