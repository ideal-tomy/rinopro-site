  ...
  return (
    ...
    >
      <h1
        ...
        className="max-w-[36ch] text-center text-[clamp(2rem,6.5vw,3.75rem)] font-bold leading-[1.22] tracking-tight text-white text-balance md:leading-[1.2] lg:text-[clamp(2.75rem,5vw,4rem)]"
      >
        {c.headlineLine1}
        <br />
        {c.headlineLine2}
      </h1>
      <p className="mx-auto mt-8 max-w-[40ch] text-center text-[17px] font-medium leading-[1.8] text-white/[0.85] md:mt-10 md:text-[18px]">
        {c.subheadline}
      </p>
      <p className="mx-auto mt-6 max-w-[40ch] whitespace-pre-line text-center text-[16px] leading-[1.8] text-white/[0.85] md:mt-8 md:text-[17px]">
        {c.body}
      </p>
