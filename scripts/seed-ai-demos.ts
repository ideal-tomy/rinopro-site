 ...
 * nextMockDemos: scripts/demo-batches/ で結合（batch-01〜10: 計92本 mock_preview）
 */
...
概算レンジはデモ画面では **150万円〜250万円（税別）** 想定の例です（セキュリティ・基本運用込み）。オプションは20万円台からの積み上げ例を表で掲載しています。正式見積はヒアリング後にご提示します。`,
