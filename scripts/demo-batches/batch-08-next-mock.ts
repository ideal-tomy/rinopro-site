...
明日の発注量調整案。人気SKUの陳列面変更。週次レビューで扱う論点。`,
    ...
    description:
      "口述メモから廃棄記録と改善共有を即整理。ロス可視化の入力を短くします。インタラクティブ体験: /experience/grocery-freshness-voice-waste-log（Live Sync）。",
    industryTags: ["小売", "飲食"],
...
電源容量の余裕は小。追加機材は要相談。警備との搬入経路確認は未。`,
    ...
    ctaButtonText: "3営業日で試作デモを受け取る",
    description:
      "立ち合いの音声からタイムラインとリスクメモを即整理。本番前の共有資料を速く作れます。インタラクティブ体験: /experience/venue-loadin-voice-timeline（Live Sync）。",
